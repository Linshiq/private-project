...
/*
  显示当前页码
 */
function PpageCountNum(){
   var count = document.getElementById("pagenum").value;
   var pNum=0;
   if(this.pageIndex >=0){
	   count = pNum; 
	   document.getElementById("pagenum").innerHTML = count;
   }
   setInterval("PpageCountNum()",1000);//1000为1秒钟
}