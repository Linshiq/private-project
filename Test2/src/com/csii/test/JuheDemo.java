...
/**
 * 问答机器人调用示例代码 － 聚合数据 在线接口文档：http://www.juhe.cn/docs/112
 **/
...
public class JuheDemo {
	...
	// 配置您申请的KEY
	public static final String APPKEY = "e8f7330b657da7196787bb5ea14f1f80";
	...
	public static void getRequest1() {
		...
		params.put("info", "你好");// 要发送给机器人的内容，不要超过30个字符
		params.put("dtype", "");// 返回的数据的格式，json或xml，默认为json
		params.put("loc", "深圳");// 地点，如北京中关村
